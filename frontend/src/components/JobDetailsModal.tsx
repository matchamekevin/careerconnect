      ...
      <div className="bg-white rounded-lg shadow-lg max-w-lg w-full p-8 relative" onClick={(e) => e.stopPropagation()}>
        ...
        {job && (
          <>
            ...
            <div className="mb-4">
              <span className="inline-block px-3 py-1 bg-gray-200 text-gray-800 rounded-full text-xs font-medium mr-2">{job.type}</span>
              <span className="inline-block px-3 py-1 bg-gray-300 text-gray-800 rounded-full text-xs font-medium mr-2">{job.salary}</span>
