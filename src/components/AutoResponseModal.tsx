            ...
            <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                <div className="p-6">
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg mb-6">
                        <h3 className="font-semibold text-blue-900">Candidat :</h3>
                        <p className="text-blue-800">{candidateInfo.firstName} {candidateInfo.lastName}</p>
                        <p className="text-blue-700 text-sm">{candidateInfo.email} • {candidateInfo.phone}</p>
                        <p className="text-blue-700 text-sm">Poste : {jobTitle}</p>
                    </div>
